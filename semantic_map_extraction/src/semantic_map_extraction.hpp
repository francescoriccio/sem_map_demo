...
class SemanticNode {
	...
	public:
		SemanticNode(ros::NodeHandle *n, std::string robotname="robot0", std::string path="./", std::string StatXMLFilePath="./mapXMLfile.xml", std::string DinXMLFilePath="./mapXMLfile.xml", int timeout=30, bool wait_service=false, bool load_dyn_map=true);
		SemanticNode(ros::NodeHandle *n, const cv::Mat &image, std::string robotname="robot0", std::string path="./", std::string StatXMLFilePath="./mapXMLfile.xml", std::string DinXMLFilePath="mapXMLfile.xml", int timeout=30, bool wait_service=false, bool load_dyn_map=true);
		~SemanticNode();
		void mapProcessing();
		...
		void ObservationTopicSubscriber(const semantic_map_extraction::Obs::ConstPtr& observation);
		...
		bool cellByCoordsHandler(semantic_map_extraction::GetCellByCoords::Request &req, semantic_map_extraction::GetCellByCoords::Response &res);
		bool coordsByCellHandler(semantic_map_extraction::GetCoordsByCell::Request &req, semantic_map_extraction::GetCoordsByCell::Response &res);
		bool deleteMapHandler(semantic_map_extraction::DeleteMap::Request &req, semantic_map_extraction::DeleteMap::Response &res);
		void showImages();
