...
ColorExtractor::ColorExtractor(const cv::Scalar &color_lb, const cv::Scalar &color_ub) {
	this->setColorRange(color_lb, color_ub);
}

void ColorExtractor::setColorRange(const cv::Scalar &color_lb, const cv::Scalar &color_ub) {
